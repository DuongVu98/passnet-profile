...
import { AddExperienceCommand, BaseCommand, CreateProfileCommand, EditExperienceCommand, JoinClassroomCommand, LeaveClassroomCommand, RemoveExperienceCommand, UpdateProfileCommand } from "src/app/domain/commands/commands";
...
export class CommandExecutorFactory {
    ...
    constructor(private profileRepository: ProfileEntityRepository, private classroomRepository: ClassroomEntityRepository, private experienceRepository: ExperienceEntityRepository){}
